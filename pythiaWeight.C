...
void pythiaWeight(){
  ...
  double xsSUM[] = {5506.30330502,5505.4421297,5505.40422409,5505.40045196,5505.40005409,5505.40000706,5505.40000172,5505.40000034,5505.40000012,5505.40000002,5505.40000001};
  ...
  for(int ie = 0; ie < tChain->GetEntries(); ++ie){//Event loop
    ...
    case 2:
      ...
      Float_t numerator = goodJet[0]-goodJet[1];
      Float_t denominator=goodJet[0]+goodJet[1];
      Float_t Aj=numerator/denominator;
