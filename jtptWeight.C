...
void jtptWeight(){
  ...
  double xsSUM[] = {4878812.4,4218696.2,4659866.4,4049616.0,2934218.1,1695768.4,-1,718081.6,578537.1,291444.26,168207.79
}; //-1 is for run six
  double xsQCD[] = {286240.0,444780.0,494830.0,514200.0,554520.0,482280.0,309090.0,304490.0,173850.0,114700.0
};
  ...
  for(int i = 0; i < Npt; ++i){//fill n[i] loop
    if(xsSUM[i]==0){n[i]=0;continue;}//without this n[6] will return things like -825280132 or  1796752684
