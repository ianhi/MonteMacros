...
void ppDataAltOut(const int startfile=0,int endfile=-1,int radius=3){
  cout<<"IN MACRO\n";
  ...
  //DEFINE OUTPUT FILE===========================================
  TFile f(Form("ROOT/pp_data_AltOut_%d.root",endfile),"RECREATE");
  f.cd();
  cout<<"output file: "<<Form("ROOT/pp_data_AltOut_%d.root",endfile)<<endl;
  //DEFINE HISTOGRAMS=============================================
  ...
  for(int ifile=startfile;ifile<endfile;ifile++){
    ...
    if(DEBUG_SHORT)nentries = 100000;
